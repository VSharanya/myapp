...
function Home() {
  return (
    <div className='text-center'>
        <h1 className='display-2 text-info'>Home</h1>
        <img src='https://img.freepik.com/premium-photo/technology-lines-background-generative-ai_317958-629.jpg' alt='hi'className='w-50'/>
        <p className='lead'>
